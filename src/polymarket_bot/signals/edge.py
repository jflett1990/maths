...
def evaluate_market(
    market: Market,
    cfg: AppConfig,
    cross: ConstraintViolation | None = None,
    exogenous: float | None = None,
    wallet_signal: WalletSignal | None = None,
    ...
    sentiment_alpha = sentiment_score * 100 * cfg.edge_weights.sentiment
    oracle_divergence_alpha = 0.0
    if oracle_probability is not None:
        oracle_divergence_alpha = (oracle_probability - market.yes_price) * 10000 * cfg.edge_weights.oracle_divergence

    orderbook_edge = forecast_alpha + cross_market_alpha + wallet_alpha + spread_reward_alpha - execution_cost
    expected_edge = (orderbook_edge * cfg.edge_weights.orderbook) + sentiment_alpha + oracle_divergence_alpha - uncertainty_penalty - tox * 100 - res * 100
    ...
    return SignalResult(
        ...
        sentiment_alpha_bps=sentiment_alpha,
        oracle_divergence_alpha_bps=oracle_divergence_alpha,
